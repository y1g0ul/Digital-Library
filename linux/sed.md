...
sr-ease: 250
---
Stream EDitor это мощный потоковый текстовый редактор в [[Linux]], используемый для автоматизированного редактирования файлов или потоков данных (через конвейер) без открытия их в текстовом редакторе.
```
